...
import com.cognizant.cms.process.CurrentPeriodProcess;
import com.cognizant.cms.util.DbUtil;


//author Shikha
//This class is used to display Contracts of the Current Period.


public class ViewCurrentDAO 
{

	public void currentperiodviewdao(String Contractid) throws ClassNotFoundException, SQLException, IOException
	{
		String userID=null;
		...
		CurrentPeriodProcess nbo=new CurrentPeriodProcess();
